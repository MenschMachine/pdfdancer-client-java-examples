 ...
 */
public final class RotatePathGroup {
    private static final String BASIC_PATHS_PATH = "src/main/resources/basic-paths.pdf";
    private static final String OUTPUT_PATH = "output/working-with-paths/rotated_group.pdf";
    private static final double ROTATION_DEGREES = 45.0;
    ...
    public static void runExample(File pdfPath, String outputPath) {
        ...
        pdf.save(outputPath);
        System.out.println("Grouped " + group.getPathCount() + " paths, rotated " + ROTATION_DEGREES + " degrees, saved to " + outputPath + ".");
    }
}
